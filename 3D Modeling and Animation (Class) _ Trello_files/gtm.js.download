...
"resource": {
  ...
  "rules":[
    [["if",2],["unless",0,1],["add",0,5,10,11,12,13,14,15,16,17,22,27,29,30]],
    [["if",4,15,16],["unless",1],["add",1,8,10,16,24],["block",30]],
    [["if",4,17],["unless",1],["add",2,4,10,16,20,23,30]],
    [["if",4,18],["unless",1],["add",3,7,10,16,20,25,28,30]],
    [["if",22,23],["add",6,9,10,16,20,25,26,28,30]],
    [["if",23,24],["add",7,20,25,28]],
    [["if",23,25],["add",18]],
    [["if",23,26],["add",19]],
    [["if",23],["add",21]],
    [["if",3,4],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28,29,30]],
    [["if",4,5],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28,29,30]],
    [["if",4,6],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28,29,30]],
    [["if",4,7],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28,29,30]],
    [["if",4,8],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28,29,30]],
    [["if",4,9],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28,29,30]],
    [["if",4,10],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28,29,30]],
    [["if",4,11],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28,29,30]],
    [["if",4,12],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28,29,30]],
    [["if",4,13],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28,29,30]],
    [["if",4,14],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28,29,30]],
    [["if",4,19],["block",3,7,10,16,20,25,27,28,29,30]],
    [["if",4,20],["block",3,7,10,16,20,25,27,28,29,30]],
    [["if",4,21],["block",3,7,10,16,20,25,27,28,29,30]]]
},
"runtime":[
[],[]
]
...
function lc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.N[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var nc={},oc=null,pc=Math.random();nc.i="GTM-PJ8M5SK";nc.Cb="9b0";var qc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0},rc="www.googletagmanager.com/gtm.js";var sc=rc,tc=null,uc=null,vc=null,wc="//www.googletagmanager.com/a?id="+nc.i+"&cv=27",xc={},yc={},zc=function(){var a=oc.sequence||0;oc.sequence=a+1;return a};var Ac={},Bc=function(a,b){Ac[a]=Ac[a]||[];Ac[a][b]=!0},Dc=function(a){for(var b=[],c=Ac[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
